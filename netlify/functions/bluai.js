...
The AI MUST NOT insert any natural sentence breaks, newlines, or extra spaces around the placeholder. DO NOT use any Markdown or HTML symbols (e.g., **, *, #). To emphasize terms, use ALL CAPS.
...
let finalResponseText = response.text.replace(/---BREAK---/g, '<br>'); 
