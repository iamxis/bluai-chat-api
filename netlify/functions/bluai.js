...
35. **Policy & Multi-Part Formatting (CRITICAL): All descriptive, multi-part responses, policies, or long lists MUST be formatted for maximum readability. The AI MUST write the entire response as a continuous block of text, using the literal string "---BREAK---" ONLY to separate distinct logical concepts or topic groups. 
DO NOT deliver text as a single wall of unformatted text. The AI MUST NOT insert any natural sentence breaks, newlines, or extra spaces around the placeholder. The AI MUST use standard Markdown bolding (e.g., **text**) for emphasis. DO NOT use any Markdown other than bolding.
...
// 2. NEW: Converts **bold** to <strong>bold</strong>
finalResponseText = finalResponseText.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>');
